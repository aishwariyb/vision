...
<head>
	...
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>Gallery</title><link rel="icon" type="image/png" href="http://visionmanit.in/img/favicon.png"> 
...
<body>
    ...
    <ul class="nav nav-tabs nav-justified" id="myTabs" style="float: none;" role="tablist"> 
        ...
        <li role="presentation" class=""> 
            <a href="#Celebs" role="tab" id="Celebs-tab" data-toggle="tab" aria-controls="Celebs" aria-expanded="false" style="font-size:25px;font-family:Economica;font-variant:small-caps">Celebrations</a> 
        </li> 
    ...
    <!-- #endregion Jssor Slider End -->
        ...
        <div class="tab-pane fade in" role="tabpanel" id="Celebs" aria-labelledby="Celebs-tab"> 
				<script src="js/jquery-1.11.3.min.js" type="text/javascript"></script>
    <script src="js/jssor.slider-22.1.6.mini.js" type="text/javascript"></script>
    <script type="text/javascript">
        jQuery(document).ready(function ($) {
    ...
    <div id="jssor_4" style="position:relative;margin:0 auto;top:0px;left:0px;width:800px;height:456px;overflow:hidden;visibility:hidden;background-color:#24262e;">
        <!-- Loading Screen -->
        <div data-u="loading" style="position: absolute; top: 0px; left: 0px;">
            <div style="filter: alpha(opacity=70); opacity: 0.7; position: absolute; display: block; top: 0px; left: 0px; width: 100%; height: 100%;"></div>
            <div style="position:absolute;display:block;background:url('img/Sliderimg/loading.gif') no-repeat center center;top:0px;left:0px;width:100%;height:100%;"></div>
