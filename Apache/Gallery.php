...
<head>
	...
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>Gallery</title><link rel="icon" type="image/png" href="img/favicon.png"> 
...
<body>
    ...
    <ul class="nav nav-tabs nav-justified" id="myTabs" style="float: none;" role="tablist"> 
        <li role="presentation" class="active">
            <a href="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true" style="font-size:25px;font-family:Economica;font-variant:small-caps">
			TechnoSearch
			</a>
        </li> 
        <li role="presentation" class="">
            <a href="#profile" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile" aria-expanded="false" style="font-size:25px;font-family:Economica;font-variant:small-caps">Noesis</a></li>
        <li role="presentation" class=""> 
            <a href="#Techno" role="tab" id="Techno-tab" data-toggle="tab" aria-controls="Techno" aria-expanded="false" style="font-size:25px;font-family:Economica;font-variant:small-caps">Workshops </a> 
            </li> 
    </ul> 
    ...
    <div id="jssor_2" style="position:relative;margin:0 auto;top:0px;left:0px;width:800px;height:456px;overflow:hidden;visibility:hidden;background-color:#24262e;">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:800px;height:356px;overflow:hidden;">
            <div>
                <img data-u="image" src="img/Sliderimg/Noesis/01.jpg" />
                <img data-u="thumb" src="img/Sliderimg/Noesis/thumb-01.jpg" />
            </div>
            <div>
                <img data-u="image" src="img/Sliderimg/Noesis/02.jpg" />
                <img data-u="thumb" src="img/Sliderimg/Noesis/thumb-02.jpg" />
            </div>
            <div>
                <img data-u="image" src="img/Sliderimg/Noesis/03.jpg" />
                <img data-u="thumb" src="img/Sliderimg/Noesis/thumb-03.jpg" />
            </div>
            <div>
                <img data-u="image" src="img/Sliderimg/Noesis/04.jpg" />
                <img data-u="thumb" src="img/Sliderimg/Noesis/thumb-04.jpg" />
            </div>
            <div>
                <img data-u="image" src="img/Sliderimg/Noesis/05.jpg" />
                <img data-u="thumb" src="img/Sliderimg/Noesis/thumb-05.jpg" />
            </div>
            <div>
                <img data-u="image" src="img/Sliderimg/Noesis/06.jpg" />
                <img data-u="thumb" src="img/Sliderimg/Noesis/thumb-06.jpg" />
            </div>
            <div>
                <img data-u="image" src="img/Sliderimg/Noesis/07.jpg" />
                <img data-u="thumb" src="img/Sliderimg/Noesis/thumb-07.jpg" />
            </div>
            <div>
                <img data-u="image" src="img/Sliderimg/Noesis/08.jpg" />
                <img data-u="thumb" src="img/Sliderimg/Noesis/thumb-08.jpg" />
            </div>
            <div>
                <img data-u="image" src="img/Sliderimg/Noesis/09.jpg" />
                <img data-u="thumb" src="img/Sliderimg/Noesis/thumb-09.jpg" />
            </div>
        ...
        <!-- Thumbnail Navigator -->
        <div data-u="thumbnavigator" class="jssort02" style="position:absolute;left:0px;bottom:0px;width:800px;height:100px;" data-autocenter="1">
            <!-- Thumbnail Item Skin Begin -->
            <div data-u="slides" style="cursor: default;">
                <div data-u="prototype" class="p">
                    <div class="w">
    ...
    <div class="tab-pane fade" role="tabpanel" id="Techno" aria-labelledby="Techno-tab"> 
            <script src="js/jquery-1.11.3.min.js" type="text/javascript"></script>
    <script src="js/jssor.slider-22.1.6.mini.js" type="text/javascript"></script>
    <script type="text/javascript">
        jQuery(document).ready(function ($) {
    ...
    <div id="jssor_3" style="position:relative;margin:0 auto;top:0px;left:0px;width:800px;height:456px;overflow:hidden;visibility:hidden;background-color:#24262e;">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:800px;height:356px;overflow:hidden;">
            <div>
                <img data-u="image" src="img/Sliderimg/Workshops/01.jpg" />
                <img data-u="thumb" src="img/Sliderimg/Workshops/thumb-01.jpg" />
            </div>
            <div>
                <img data-u="image" src="img/Sliderimg/Workshops/02.jpg" />
                <img data-u="thumb" src="img/Sliderimg/Workshops/thumb-02.jpg" />
            </div>
            <div>
                <img data-u="image" src="img/Sliderimg/Workshops/03.jpg" />
                <img data-u="thumb" src="img/Sliderimg/Workshops/thumb-03.jpg" />
            </div>
            <div>
                <img data-u="image" src="img/Sliderimg/Workshops/04.jpg" />
                <img data-u="thumb" src="img/Sliderimg/Workshops/thumb-04.jpg" />
            </div>
            <div>
                <img data-u="image" src="img/Sliderimg/Workshops/05.jpg" />
                <img data-u="thumb" src="img/Sliderimg/Workshops/thumb-05.jpg" />
            </div>
            <div>
                <img data-u="image" src="img/Sliderimg/Workshops/06.jpg" />
                <img data-u="thumb" src="img/Sliderimg/Workshops/thumb-06.jpg" />
            </div>
            <div>
                <img data-u="image" src="img/Sliderimg/Workshops/07.jpg" />
                <img data-u="thumb" src="img/Sliderimg/Workshops/thumb-07.jpg" />
            </div>
            <div>
                <img data-u="image" src="img/Sliderimg/Workshops/08.jpg" />
                <img data-u="thumb" src="img/Sliderimg/Workshops/thumb-08.jpg" />
            </div>
            <div>
                <img data-u="image" src="img/Sliderimg/Workshops/09.jpg" />
                <img data-u="thumb" src="img/Sliderimg/Workshops/thumb-09.jpg" />
            </div>
            <div>
                <img data-u="image" src="img/Sliderimg/Workshops/10.jpg" />
                <img data-u="thumb" src="img/Sliderimg/Workshops/thumb-10.jpg" />
            </div>
            <a data-u="any" href="http://www.jssor.com" style="display:none">Image Gallery</a>
            <div>
                <img data-u="image" src="img/Sliderimg/Workshops/11.jpg" />
                <img data-u="thumb" src="img/Sliderimg/Workshops/thumb-11.jpg" />
            </div>
            <div>
                <img data-u="image" src="img/Sliderimg/Workshops/12.jpg" />
                <img data-u="thumb" src="img/Sliderimg/Workshops/thumb-12.jpg" />
            </div>
        </div>
        <!-- Thumbnail Navigator -->
        <div data-u="thumbnavigator" class="jssort03" style="position:absolute;left:0px;bottom:0px;width:800px;height:100px;" data-autocenter="1">
            <!-- Thumbnail Item Skin Begin -->
            <div data-u="slides" style="cursor: default;">
                <div data-u="prototype" class="p">
                    <div class="w">
